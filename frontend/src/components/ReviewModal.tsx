...
export const ReviewModal: React.FC<ReviewModalProps> = ({ isOpen, onClose, revieweeId }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-[480px] overflow-hidden flex flex-col">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
          ...
          <div className="p-6">
            ...
            {/* Comment */}
            <div>
              <label className="block text-[14px] font-semibold text-gray-800 mb-2">Nhận xét chi tiết</label>
              <textarea
                className="w-full border border-gray-300 rounded-lg p-3.5 text-[15px] focus:ring-1 focus:ring-[#0052CC] focus:border-[#0052CC] outline-none resize-none transition-colors placeholder-gray-400"
                rows={4}
          ...
          <div className="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3 bg-white">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-2.5 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
            >
              Hủy
            </button>
            <button
              ...
              className="px-6 py-2.5 bg-[#0052CC] hover:bg-[#0047b3] text-white rounded-lg text-sm font-medium transition disabled:opacity-50"
            >
