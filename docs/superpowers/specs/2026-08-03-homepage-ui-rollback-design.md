...
- The new section shows the five newest available listings whose landlord profile is verified. The fifth card follows the original four-column grid and wraps naturally.
...
- Keep tests proving verified-landlord listings are selected independently and stop at five.
